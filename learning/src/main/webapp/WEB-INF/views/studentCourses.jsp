						...
						<div class="card" style="width: 18rem;">
							<div class="card-body">
								...
								<h5 class="card-subtitle mb-2 text-muted">${clist.courseTitle}</h6>
									...
									<a href="enrollStudent/${clist.courseID}"
										class="card-link text-center">Enroll</a>
							</div>
						</div>
					</div>
